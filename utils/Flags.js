...
const countries = [
  ...
  { name: "Papua New Guinea", countryCode: "gn" },
...
export default function Flags({ item }) {
  const country = countries.filter((country) => country.name === item);
  const flagRenderer = (code) => <Flag name={`${code}`} />;
